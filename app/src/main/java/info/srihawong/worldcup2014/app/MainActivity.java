...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        private View fragment_matchs(final View rootView){
            ...
            placeGridView.setAdapter(matchListAdapter);


            //String[] datedd = new String[]{"dsd","dsd","dsds"};
            //ArrayAdapter<String> adapter = new ArrayAdapter<String>(getActivity().getBaseContext(),android.R.layout.simple_list_item_1,datedd);
                        ...
                        for(int i=0,j=object.length();i<j;i++){
                            try {
                                ...
                                for(int k=0,l=matchTeams.length();k<l;k++){
                                    ...
                                    matchArrayList.add(new Match(matchTeam.getLong("times"),
